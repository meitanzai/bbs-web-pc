                ...
                <div class="container">
                    ...
                    <el-form :model="form" ref="formRef" :rules="rules" class="iconForm-container" size="large" >
                        <el-form-item :error="error.mobile" prop="mobile" >
                            <el-input v-model="form.mobile" placeholder="请填写新手机号" maxlength="11" @input="mobileInputChange" clearable>
                                <template #prefix>
...
<script lang="ts" setup>
    ...
    const { meta } = useMeta(
        computed(() => ({ 
            title:  '更换绑定手机第二步 - ' + store.state.title,
            meta: [
                {
                    name: 'keywords',
                    content: '更换绑定手机第二步 - ' + store.state.title
                },{
                    name: "description",
                    content: '更换绑定手机第二步 - ' + store.state.title
                }
